#! /usr/bin/env bash
# Build the ErsatzTV Docker image for linux/amd64.
#
# Local usage:
#   ./scripts/build-docker-amd64.sh
#   ./scripts/build-docker-amd64.sh --tag myregistry/ersatztv:test
#
# CI (push-by-digest) usage:
#   ./scripts/build-docker-amd64.sh \
#     --info-version "26.5.1-docker-amd64" \
#     --push-by-digest \
